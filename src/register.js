                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleRegister}>
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="College Id" onChange={(event) => { setColId(event.target.value) }}/>
                        </div>
                        <div className="mb-3">
                            <label className="form-label">Password</label>
                            <input type="password" className="form-control" placeholder="Password" onChange={(event) => { setPass(event.target.value) }}/>
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { setBranch(event.target.value) }} defaultValue="">     
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { setYear(event.target.value) }} defaultValue="">     
                        ...
                        <div className="mb-3">
                            ...
                            <div className="form-check form-check-inline" > 
                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="other" onChange={(event) => { setGender(event.target.value) }} /> 
